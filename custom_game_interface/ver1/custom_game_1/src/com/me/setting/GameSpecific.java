...
public class GameSpecific {
	...
	public static final int[] speed = { 200, 300, 200, 300, 400, 250 };
	...
	public static final int[] gunCost = { 100, 200, 150, 300 };
