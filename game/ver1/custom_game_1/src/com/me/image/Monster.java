...
//	new TextureAtlas(Gdx.files.internal("monster/monster_vinh.pack"));
	public Monster(TextureAtlas atlas) {
		super(atlas.findRegion("A1", 1));

		this.setSize(WIDTH, HEIGHT);
		this.setPosition(0, 10 * 32); // xuat phat tai o [0][10]

		MyAtlasRegion[] UpWalking = new MyAtlasRegion[] {
				new MyAtlasRegion(atlas.findRegion("A1", 1)),
				new MyAtlasRegion(atlas.findRegion("A1", 2)),
				new MyAtlasRegion(atlas.findRegion("A1", 3)) };
